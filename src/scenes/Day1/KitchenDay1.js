class KitchenDay1 extends Phaser.Scene {
    constructor() {
        super('kitchenDay1');
    }
    ...
    update(){
        ...
        if (this.checkCollision(this.p1, this.doorLeft)){
            this.p1.x = 55;
            this.scene.switch('kitchenBackDay1');
        }
        ...
        if (this.physics.overlap(this.p1, this.stephascope) && Phaser.Input.Keyboard.JustDown(this.keyR) && this.talking == false){
