class LaundryRoomDay1 extends Phaser.Scene {
    constructor() {
        super('laundryRoomDay1');
    }
    ...
    update(){
        ...
        if (this.physics.overlap(this.p1, this.shot) && Phaser.Input.Keyboard.JustDown(this.keyR) && this.talking == false){
            inventory.push("shot");
            this.shot.destroy();
        }
