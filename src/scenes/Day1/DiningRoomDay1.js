class DiningRoomDay1 extends Phaser.Scene {
    constructor() {
        super('diningRoomDay1');
    }
    ...
    update(){
        ...
        if (this.physics.overlap(this.p1, this.doorLeft)){
            this.p1.x = 55;
            this.scene.switch('stairRoomDay1');
        }
        ...
        if (this.physics.overlap(this.p1, this.needleOne) && Phaser.Input.Keyboard.JustDown(this.keyR) && this.talking == false){
            inventory.push("needleOne");
            this.needleOne.destroy();
        }

        if (this.physics.overlap(this.p1, this.rope) && Phaser.Input.Keyboard.JustDown(this.keyR) && this.talking == false){
            inventory.push("rope");
            this.rope.destroy();
        }
