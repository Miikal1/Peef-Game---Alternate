class FishTankRoomDay1 extends Phaser.Scene {
    constructor() {
        super('fishTankRoomDay1');
    }
    ...
    update(){
        ...
        if (this.physics.overlap(this.p1, this.battery) && Phaser.Input.Keyboard.JustDown(this.keyR) && this.talking == false){
