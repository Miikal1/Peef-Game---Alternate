class StairRoomDay1 extends Phaser.Scene {
    constructor() {
        super('stairRoomDay1');
    }
    ...
    update(){
        ...
        if (this.physics.overlap(this.p1, this.needleTwo) && Phaser.Input.Keyboard.JustDown(this.keyR) && this.talking == false){
        ...
        if (this.physics.overlap(this.p1, this.doorSide) && Phaser.Input.Keyboard.JustDown(this.keyR)){
            this.p1.x = 314;
            this.scene.switch('fishTankRoomDay1');
        }
