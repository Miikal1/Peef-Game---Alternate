class BedRoomDay2 extends Phaser.Scene {
    constructor() {
        super('bedRoomDay2');
    }
    ...
    update(){
        ...
        if (pickingQuest == "complete" && squeezeQuest == "complete" && deliveryQuest == "complete" && safeQuest == "complete" && fishFoodQuest == "complete" && towerQuest == "complete"){
